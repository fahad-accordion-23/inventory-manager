...
public class ProductViewModel {
    ...
    public ObjectProperty<BigDecimal> taxRateProperty() { return taxRate; }
    ...
    public BigDecimal getTaxRate() { return taxRate.get(); }
    ...
    public void setSellingPrice(BigDecimal sellingPrice) { this.sellingPrice.set(sellingPrice); }
    public void setStockQuantity(int stockQuantity) { this.stockQuantity.set(stockQuantity); }
    public void setTaxRate(BigDecimal taxRate) { this.taxRate.set(taxRate); }
}
