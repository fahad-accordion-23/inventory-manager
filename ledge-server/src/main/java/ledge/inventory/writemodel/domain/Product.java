...
public class Product {
    ...
    private Product(UUID id, String name, BigDecimal purchasePrice, BigDecimal sellingPrice, int stockQuantity,
            BigDecimal taxRate) {
        this.id = id;
    ...
    public static Product register(String name, BigDecimal purchasePrice, BigDecimal sellingPrice, int stockQuantity,
            BigDecimal taxRate) {
        return new Product(UUID.randomUUID(), name, purchasePrice, sellingPrice, stockQuantity, taxRate);
    }

    public static Product rehydrate(UUID id, String name, BigDecimal purchasePrice, BigDecimal sellingPrice,
            int stockQuantity, BigDecimal taxRate) {
        if (id == null) {
